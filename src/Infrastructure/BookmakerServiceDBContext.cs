...
namespace BookmakerService.Infrastructure
{
    using System;
    using System.Linq;
    ...
    /// <summary>
    /// <see cref="BookmakerServiceDBContext"/>
    /// </summary>
    /// <seealso cref="DbContext"/>
    /// <seealso cref="IUnitOfWork"/>
    public class BookmakerServiceDBContext : DbContext, IUnitOfWork
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BookmakerServiceDBContext"/> class.
        /// </summary>
        /// <param name="configuration">The configuration.</param>
        /// <param name="mediator">The mediator.</param>
        public BookmakerServiceDBContext(
            IConfiguration configuration,
            IMediator mediator,
            DbContextOptions<BookmakerServiceDBContext> options)
            : base(options)
        {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            optionsBuilder
                ...
                .UseMySql(
                    this.configuration.GetSection(BookmakerServiceDBContext.DatabaseConnectionSection).Value,
